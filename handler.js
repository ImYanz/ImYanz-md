...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: `${yanz}`, body: `${yanz1}`, thumbnailUrl: thumb, sourceUrl: ''}}}}, aa);
